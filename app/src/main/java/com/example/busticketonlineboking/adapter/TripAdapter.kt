...
class TripAdapter:RecyclerView.Adapter<TripAdapter.TripViewHolder>() {
    ...
    inner class TripViewHolder(itemView: View):RecyclerView.ViewHolder(itemView),View.OnClickListener{
        ...
        fun bindTripData(result: Trip){
            ...
            Log.d("Price>>>>",result.foregin_price)
        }
    ...
    fun  updateList(result: List<Trip>){
